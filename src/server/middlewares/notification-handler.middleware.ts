...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'menu.update': { roles: ['owner', 'waiter'], key: 'menu-updated', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'table.create': { roles: ['owner', 'chef'], key: 'table-created', tenantPath: ['restaurant', 'table'], userPath: [] },
  'reservation.create': {
